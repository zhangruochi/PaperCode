...
#------------------接口-------------------------------
    ...
    dataset,y = prepare_dataset_labels(dataset_filename,clinical_filename)
    dataset = dataset.T
...
if __name__ == '__main__':
    dataset_filename = "LUAD/matrix_data_luad.tsv"
    clinical_filename = "LUAD/clinical_luad.json"

    main(dataset_filename,clinical_filename, var_filter = 0.02, k_fold = 5, estimator_name = "LG")
