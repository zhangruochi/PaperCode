...
def get_chr_file(meth_filename,loc_filename,json_filename,length):
    ...
    dir_name = "output_{}".format(length)
    ...
    for chr_name, data_matrix in chr_matrix.items():
        ...
        np.savetxt('{}/chromosome_{}.csv'.format(dir_name,chr_name),chr_data_matrix, delimiter = ',')
