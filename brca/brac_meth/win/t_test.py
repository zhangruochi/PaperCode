...
#对每一个数据集进行运算
def t_test_main(dataset_filename,class_filename,estimator = ["SVM","KNN","DT","NB","LG"],feature_range = 10,k_fold = 10,seed_number = 7):
...
if __name__ == '__main__':
    ...
    """
    single(dataset_filename = "chromosome_1.csv",class_filename = "labels.csv",\
