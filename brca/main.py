...
#四分类的准确性   
def four_class_acc(dataset,feature_list,labels,estimator_list,skf):
    max_estimator_aac = 0
    for estimator in estimator_list:
        estimator_aac = get_aac(OneVsOneClassifier(select_estimator(estimator)),dataset.iloc[:,feature_list],labels,skf)
...
def main(dataset_filename,json_filename,feature_range = 20,n_splits = 10,criterion = "aic",\
    ...
    macc = four_class_acc(dataset,feature_list,labels,estimator_list,skf)
