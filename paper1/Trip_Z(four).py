...
#------- 参数设定 -----------------------------------------------------------
    ...
    n_foldername_1 = "Gastric_ulcer_Sub"
    n_foldername_2 = "Gastric_polyp_Sub"
    n_foldername_3 = "Gastritis_Sub"
...
#---------------------------------------------------------------------------   
    ...
    for i in estimator_list:    
        acc,sn,sp,mcc = evaluate(OneVsRestClassifier(select_estimator(i)),dataset,labels,skf)
        print("Acc: ",acc)
        print("Sn: ",sn)
        print("Sp: ",sp)
        print("Mcc: ",mcc)
